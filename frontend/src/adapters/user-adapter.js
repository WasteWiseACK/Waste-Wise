...
export const updateUsername = async ({ id, username, bio, borough, other_form_of_contact }) => {
  return fetchHandler(`${baseUrl}/${id}/edit`, getPatchOptions({ id, username, bio, borough, other_form_of_contact }))
}
