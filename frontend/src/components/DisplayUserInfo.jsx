...
function DisplayUser() {
    ...
    return (
        <>
            ...
            {currentUser.borough ? <p>Based in: {currentUser.borough}</p> : <p>You haven't set your location yet.</p>}
            {currentUser.bio ? <p>{currentUser.bio}</p> : <p>Add something to your about me!</p>}
            {currentUser.other_form_of_contact ? <p>Links: {currentUser.other_form_of_contact}</p> : <p></p>}
